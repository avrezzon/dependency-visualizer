    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans p-6">
      ...
      >
        <div className="space-y-4">
          <div>
            <label htmlFor="dep-name" className="block text-sm font-medium text-slate-700 mb-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="dep-org" className="block text-sm font-medium text-slate-700 mb-1">
                Organization
              </label>
              <input
                id="dep-org"
            ...
            <div>
              <label htmlFor="dep-artifactId" className="block text-sm font-medium text-slate-700 mb-1">
                Artifact ID
              </label>
              <input
                id="dep-artifactId"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="dep-version" className="block text-sm font-medium text-slate-700 mb-1">
                Version
              </label>
              <input
                id="dep-version"
            ...
            <div>
              <label htmlFor="dep-category" className="block text-sm font-medium text-slate-700 mb-1">
                Category
              </label>
              <select
                id="dep-category"
